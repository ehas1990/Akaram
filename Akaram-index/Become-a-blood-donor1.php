...
<body>
  <!--preloader start-->
  <div class="preloader">
    <h1><a href="index.html"><img src="assets/images/Akaram_a_trans.png" class="logo-preloder"></a></h1>
    <h1>ASYC</h1>
        ...
        <div class="row align-items-center position-relative">
          <div class="col-xl-2 col-lg-2 col-md-4 col-6">
            <div class="header_logo">
              <a href="index.html"><img src="assets/images/Akaram_a.jpg" alt="images not founds" class="img-fluid"></a>
            </div>
          </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10 col-12 text-center">
          ...
          <ul>
           ...
           if(isset($_REQUEST['rstatus']))
   			{
			  echo '<br><ul><li><h3><ul><li><h3>REGISTRATION SUCCESSFUL </h3></li></ul>';
            }
			?>
        </div>
      </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-4 col-lg-4 col-md-4 col-12">
            <img src="assets/images/akaram_donation.jpg">
          </div>
          <!--  -->
 		...
 		$sql = "SELECT DISTINCT id,name FROM geo_locations where location_type = 'STATE'";
		$states = $conn->query($sql);
		while($row = $states->fetch_assoc())
        {
            echo ("<option value=".$row["id"]. ($sel_state == $row["id"] ? " selected" : "") . ">		$row[name]</option>");
        }
  ...
  <div class="offcanvas offcanvas-start" id="offcanvas-mobile">
    <div class="offcanvas-body">
      <div class="mobile-menu">
        <a href="index-3.html" class="logo mobile py-3"><img src="assets/images/Akaram_a.jpg" alt="logo"
            class="img-fluid"></a>
